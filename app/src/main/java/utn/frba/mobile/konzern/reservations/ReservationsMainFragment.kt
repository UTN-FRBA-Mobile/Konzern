...
class ReservationsMainFragment : Fragment(), OnReservationClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.dayReservations.observe(viewLifecycleOwner, Observer<List<Reservation>> {
            rvReservationsCards.adapter = ReservationAdapter(it, viewModel, this)
        })
    ...
    override fun onDeleteClick(id: String, date: String) {
        viewModel.deleteReservation(id, date)
    }
}
